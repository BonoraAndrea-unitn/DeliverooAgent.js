 ...
 */
export async function onlineFetch(pddlDomain, pddlProblem, print) {
 ...
 * @returns { Promise < [ { parallel: boolean, action: string, args: [string] } ] > }
 */
export async function onlineSolve(pddlDomain, pddlProblem, print = true) {
    return await onlineFetch(pddlDomain.content, pddlProblem.content, print)
}
